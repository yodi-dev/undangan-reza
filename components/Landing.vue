<template>
  <section class="relative flex items-end justify-center h-screen bg-cover bg-center"
    ...
    <!-- Content -->
    <div
      class="relative mb-24 bg-white/10 text-white text-center px-8 py-10 rounded-3xl shadow-2xl max-w-lg animate-fade-in space-y-5">
