  ...
  <section id="gift" class="py-20 bg-rose-50">
    <div class="max-w-2xl mx-auto px-4 text-center space-y-10">
      <div>
        ...
        <p class="text-gray-600">Doa restu Anda merupakan hadiah terindah. Namun, jika ingin mengirimkan tanda kasih, kami siapkan informasi berikut:</p>
      </div>
      ...
      <!-- QRIS -->
      <div class="pt-8">
        <p class="font-semibold text-gray-700 mb-2">Atau scan QRIS berikut:</p>
        <div class="inline-block p-4 bg-white rounded-xl shadow-md">
          <img :src="qrisImage" alt="QRIS Code" class="w-48 h-48 object-contain" />
        </div>
      </div>
...
const banks = ref([
  { name: 'Bank BCA', account: '1234 5678 9012', owner: 'Nara & Pasangan' },
  { name: 'Bank Mandiri', account: '9876 5432 1098', owner: 'Nara & Pasangan' }
])
